...
def _run_lane(
    ...
    if lane != "native_matr":
        ...
        if getattr(args, "event_d16_variant", "none") != "none":
            gradient_norms.update(
                {
                    "matr_segment_decoder": _gradient_norm(
                        module.segment_decoder.layers[0].multihead_attn.in_proj_weight,
                        "segment_decoder.layers.0.multihead_attn.in_proj_weight",
                    ),
                    "matr_memory_decoder": _gradient_norm(
                        module.memory_decoder.layers[0].multihead_attn.in_proj_weight,
                        "memory_decoder.layers.0.multihead_attn.in_proj_weight",
                    ),
                }
            )
    ...
    receipt = {
        ...
        "event_d16_variant": getattr(args, "event_d16_variant", "none"),
        ...
        "owner_risk_contract": getattr(module, "event_owner_risk_contract", None),
