...
optimization_pilot_contract = dict(
    ...
    transition_capacity_revision="entry_free_4_visible_plus_2_birth_reserve_v1",
)
...
model = dict(
    ...
    head=dict(num_slots=6),
)
work_dir = "exps/thumos/persistent_binding_opt_reserve_fixed_seed705"
