...
3. **C / SW+CT**：A 加 causal query transport（weight 0.05）。上一有效
   ...
   `0.25`、identity cost `0.25`、56 次 log-space Sinkhorn。
...
当前 exact `f6bd9e12b60749c1244815fca30f9fca7bbdf4bf`。
...
0.25/56。04:54 账户仍为 16/16，新三版本等待槽位按 A→B→C 重提；
只认 exact `f6bd9e1`，旧取消目录不算 duplicate。
